...
import sqlite3  # sqlite3 для работы с базами данных приложения
...
class Main(QMainWindow, Ui_MainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QIcon('main_icon.png')) # настройка название и иконки главного окна
    ...
    def dark_theme_off(self):
        ...
        self.setStyleSheet('''QMessageBox {background-color: #5b92e5; width: 700px; height: 400px}
                              ...
                              QComboBox::down-arrow {color: white; image: url(arrow(1).jpg);}
